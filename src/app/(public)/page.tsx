        ...
        <div className="mx-auto max-w-5xl px-4 pt-14 pb-20 sm:pt-24 sm:pb-28">
          ...
          <div className="rise-late">
            <p className="mt-7 max-w-xl text-lg leading-relaxed text-white/70">
              Around 450 people will fill the theater for a day of ideas. About 35
              volunteers make it run — at the doors, in the aisles, backstage, and at the
              speaker coaching nights in the months before. Pick the shifts that fit your
              life.
            </p>
        ...
        <ol className="grid gap-10 sm:grid-cols-3 sm:gap-8">
          {STEPS.map((s, i) => (
            <li key={s.title} className="border-t-4 border-ink pt-4">
              <span className="inline-flex h-7 w-7 items-center justify-center rounded-full bg-ted font-display text-sm font-extrabold text-white">
                {i + 1}
              </span>
